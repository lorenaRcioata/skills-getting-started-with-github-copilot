...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the soccer team to improve your skills and compete in matches",
    ...
    "Drama Club": {
        "description": "Participate in acting exercises and perform in school plays",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["sophia@mergington.edu", "jackson@mergington.edu"]
    },
    "Math Club": {
        "description": "Engage in math challenges and prepare for math competitions",
